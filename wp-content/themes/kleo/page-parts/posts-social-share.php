...
<section class="container-wrap">
	<div class="container">
      ...
      <span class="kleo-mail">
      	<a href="mailto:?subject=<?php the_title(); ?>&body=<?php echo esc_attr( strip_tags( do_shortcode(get_the_content()), '<a>,<img>,<br>' ) ); ?> <?php the_permalink(); ?>" class="post_share_email"><i class="icon-mail"></i>
					</a>
      </span>
