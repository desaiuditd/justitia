...
<dl role="main">
	...
	<dt><?php _e( 'Categories', 'bbpress' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['forum_count'] ); ?></strong>
	</dd>

	<dt><?php _e( 'Stories', 'bbpress' ); ?></dt>
	<dd>
	...
	<dt><?php _e( 'Story Tags', 'bbpress' ); ?></dt>
	<dd>
	...
	<?php if ( !empty( $stats['empty_topic_tag_count'] ) ) : ?>
		...
		<dt><?php _e( 'Empty Story Tags', 'bbpress' ); ?></dt>
		<dd>
	...
	<?php if ( !empty( $stats['topic_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Stories', 'bbpress' ); ?></dt>
		<dd>
			<strong>
