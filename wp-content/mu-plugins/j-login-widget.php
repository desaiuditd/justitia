 ...
 * @see WP_Widget
 */
class J_Widget_Login extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'j_widget_login',
			'description' => __( 'Justitia Login' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'j_login', __( 'Justitia Login' ), $widget_ops );
	}
...
add_action( 'widgets_init', function(){
	register_widget( 'J_Widget_Login' );
});
